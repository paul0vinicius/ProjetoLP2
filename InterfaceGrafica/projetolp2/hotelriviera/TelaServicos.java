...
public class TelaServicos extends JFrame {
	...
	public TelaServicos() {
		setResizable(false);
		setTitle("Hotel Riviera - Sistema de Manuten\u00E7\u00E3o de Clientes e Servi\u00E7os - Serviços");
		...
		background.setIcon(new ImageIcon("C:\\Users\\Pedro Paulo\\workspace\\hotelriviera\\Media\\background_servicos.png"));
